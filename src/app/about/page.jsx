            ...
            <section>
                ...
                >
                    <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
                        ...
                        <div className="relative flex items-center bg-[#313131]">
                            <span className="hidden lg:absolute lg:inset-y-0 lg:-start-16 lg:block lg:w-16 bg-[#313131]"></span>

                            <div className="p-8 sm:p-16 lg:p-24">
                                <motion.h2
                                    className="text-2xl font-medium sm:text-3xl"
                                    initial={{ opacity: 0, x: -50 }} // Start off-screen to the left
                                    animate={isFirstAnimationComplete ? { opacity: 1, x: 0 } : { opacity: 0 }} // Animate to full opacity and position
                                    transition={{ duration: 1, delay: 0.7 }} // Duration and delay for the fade-in
                                >
                                    We’re redefining the interior design experience by offering you everything
                                </motion.h2>
                                ...
                                <motion.p
                                    ...
                                    initial={{ opacity: 0, x: -50 }} // Start off-screen to the left
                                    animate={isFirstAnimationComplete ? { opacity: 1, x: 0 } : { opacity: 0 }} // Animate to full opacity and position
                                    transition={{ duration: 1, delay: 0.8 }} // Duration and delay for the fade-in
                                >
                                    Visualize, and complete your project with confidence. Our easy-to-use tools and professional guidance make it simple to explore your style and create spaces that inspire joy and comfort.
                                </motion.p>

                                <a
                                    href="#"
                                    className="mt-8 inline-block rounded border border-gray-600 bg-gray-600 px-12 py-3 text-sm font-medium text-gray-200 hover:bg-transparent focus:outline-none"
                                >
                                    Get in Touch
                                </a>
                            </div>
